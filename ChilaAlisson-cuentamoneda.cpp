...
//==> Archivo: ChilaAlisson-cuentamoneda.cpp
...
int main()
{
	...
	float QE_x, QE_a=0, QE_a1=0, QE_a2=0, QE_m=0.10;
...
cout<<endl<<"//====================================================================="<<endl;	
	cout<<"//=====Nombre del programa: cuenta moneda  "<<endl;
        cout<<"//=====Archivo: ChilaAlisson-cuentamoneda.cpp"<<endl;
        cout<<"//=====Autor: CHILA QUIÑONEZ ALISSON ELNA "<<endl;
